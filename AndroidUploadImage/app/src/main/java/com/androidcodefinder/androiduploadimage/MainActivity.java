    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UploadImageOnServerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                GetImageAxis = textview.getText().toString();
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                ...
                HashMapParams.put(ImageAxis, GetImageAxis);

                String FinalData = imageProcessClass.ImageHttpRequest("http://192.168.1.10/Android Upload Image Php files/upload-image-to-server.php", HashMapParams);
